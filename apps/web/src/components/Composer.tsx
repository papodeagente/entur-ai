  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        disabled={disabled}
        className={cn(
          'flex-1 bg-transparent outline-none resize-none text-base sm:text-[15px] leading-6 px-2 py-1.5',
          'placeholder:text-text-tertiary disabled:opacity-50'
        )}
      />

      <div className="flex items-center gap-1.5 sm:gap-2 px-1 flex-wrap">
        <input
          ref={fileRef}
          type="file"
          multiple
        ...
        {(supportsAttach || isImage) && (
          <button
            ...
            className="text-text-secondary hover:text-text-primary p-2 rounded transition-colors min-h-[40px] min-w-[40px] flex items-center justify-center"
          >
            📎
          </button>
        )}
        ...
        <div className="ml-auto">
          <button
            ...
            className={cn(
              ...
              'bg-accent-teal text-bg-base hover:bg-accent-teal-hi active:bg-accent-teal/80',
